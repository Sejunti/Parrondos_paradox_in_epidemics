...
def approximate_matrix(beta,mu,T,barA):
    """
    Function computes the first-order approximation of matrix, T. 
    Parameters:
              beta(float):Infection rate
              mu(float):Recovery rate
              T(integer):Period 
              barA(numpy array):Time-averaged adjacency matrix
    Returns:
...
def approximate_largest_eigenvalue(beta,mu,T,barA):
    """
    Function computes the first-order approximation of the largest eigenvalue of matrix, T. 
    Parameters:
              beta(float):Infection rate
              mu(float):Recovery rate
              T(integer):Period 
...
def approximate_lamda_F(beta,mu,T,barA):
    """
    Function computes the first-order approximation of the largest Floquet exponent. 
    Parameters:
              beta(float):Infection rate
              mu(float):Recovery rate
              T(integer):Period 
